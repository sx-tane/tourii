...
const ChapterPage: React.FC = () => {
    ...
    const chapterId = Array.isArray(params.storyChapterId) ? params.storyChapterId[0] : params.storyChapterId;
    ...
    const { storyChapter: directChapters, isLoadingSaga, isErrorSaga } = useSagaById(storyId);
    ...
    const handleNextChapter = () => {
        ...
        if (nextChapter?.isUnlocked) {
            router.push(`/v2/touriiverse/${storyId}/chapters/${nextChapter.storyChapterId}`);
        }
    };
    ...
    const handlePreviousChapter = () => {
        ...
        if (previousChapter) {
            router.push(`/v2/touriiverse/${storyId}/chapters/${previousChapter.storyChapterId}`);
        }
    };
