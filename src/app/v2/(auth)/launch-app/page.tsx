...
const LaunchAppPage = () => {
    ...
    const handleSocialSignIn = async (provider: 'google' | 'discord' | 'twitter') => {
        setIsLoading(true);
        setError(null);
        try {
            ...
            <div className="max-w-md w-full">
                <div className="bg-white p-8 rounded-lg shadow-md">
                    <div className="text-center mb-8">
                        <h2 className="text-3xl font-bold text-gray-900">Welcome to Tourii</h2>
                        {process.env.NODE_ENV === 'development' ? (
                            <p className="mt-2 text-sm text-gray-600">
                                Development Mode: Click any button to continue as {mockAccount.name}
                            </p>
                        ) : (
                            <p className="mt-2 text-sm text-gray-600">
                                {showCredentials
                        ...
                        {showCredentials ? (
                            ...
                            <>
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    ...
                                    >
                                        <svg className="w-5 h-5" viewBox="0 0 24 24" aria-labelledby="googleIconTitle">
