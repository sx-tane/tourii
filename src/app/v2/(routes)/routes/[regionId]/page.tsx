...
const RegionRoutesPage = ({ params }: RoutePageProps) => {
                    ...
                    >
                        <div className="p-6">
                            <div className="flex items-center justify-between mb-2">
                                ...
                                <span className={`px-2 py-1 text-xs font-medium rounded ${route.difficulty === 'Easy' ? 'bg-green-100 text-green-800' :
                            ...
                            <div className="mt-4 pt-4 border-t">
                                <button
                                    type="button"
                                    onClick={() => router.push(`/v2/routes/${params.regionId}/${route.id}`)}
