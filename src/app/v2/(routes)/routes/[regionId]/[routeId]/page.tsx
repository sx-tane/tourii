...
const RouteDetailPage = () => {
	...
	const [route] = useState<Route>({
		...
		description:
			"Follow the historic stone path through Kyoto's temple district, from Ginkaku-ji to Nanzen-ji. This peaceful walk takes you along a cherry-tree-lined canal, past numerous small temples and through the heart of Kyoto's cultural heritage.",
		type: "walking",
		location: "Kyoto",
		distance: "2.5 km",
		duration: "1-2 hours",
		...
		startPoint: {
			...
			description:
				"The Silver Pavilion, a Zen temple at the northern end of the path",
			coordinates: {
				lat: 35.027103,
				lng: 135.798374,
			},
