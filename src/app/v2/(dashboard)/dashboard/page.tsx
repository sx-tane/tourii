    ...
    return (
        <div className="space-y-6">
            ...
            <div className="bg-white shadow-sm rounded-lg p-6">
                <h1 className="text-2xl font-bold text-gray-900">Welcome back, {userData?.name || 'Explorer'}!</h1>
                <p className="mt-1 text-gray-500">Continue your journey through Japan's mystical tales.</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-white shadow-sm rounded-lg p-6">
                    ...
                    <div className="mt-2">
                        <p className="text-3xl font-bold text-indigo-600">{mockDashboardData.user.chapter.title}</p>
                        <p className="text-sm text-gray-500">
                            Chapter {mockDashboardData.user.chapter.current} of {mockDashboardData.user.chapter.total}
                        </p>
                    </div>
                </div>
                ...
                <div className="bg-white shadow-sm rounded-lg p-6">
                    ...
                    <div className="mt-2">
                        <p className="text-3xl font-bold text-indigo-600">{mockDashboardData.user.points}</p>
                        <p className="text-sm text-gray-500">Level {mockDashboardData.user.level} Explorer</p>
                    </div>
                </div>
                ...
                <div className="bg-white shadow-sm rounded-lg p-6">
                    ...
                    <div className="mt-2">
                        <p className="text-3xl font-bold text-indigo-600">{mockDashboardData.user.quests.active}</p>
                        <p className="text-sm text-gray-500">
                            {mockDashboardData.user.quests.online} Online, {mockDashboardData.user.quests.offline} Offline
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="bg-white shadow-sm rounded-lg p-6">
                ...
                <div className="space-y-4">
                    {mockDashboardData.user.recentActivity.map((activity) => (
                        <div key={`${activity.type}-${activity.text}`} className="flex items-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    >
                        <div>
                            ...
                            <p className="text-sm text-gray-500">Resume "The Fox's Wedding" chapter</p>
                        </div>
                    ...
                    >
                        <div>
                            <h3 className="font-medium text-gray-900">Complete Daily Quest</h3>
