...
export async function PUT(request: NextRequest, { params }: { params: Promise<{ modelRouteId: string }> }) {
    ...
    try {
        ...
        return executeValidatedServiceCall(
            (apiKey: string, apiVersion: string) =>
                RoutesService.touriiBackendControllerUpdateModelRoute(apiVersion, apiKey, {
                    ...body,
                    modelRouteId
                }),
