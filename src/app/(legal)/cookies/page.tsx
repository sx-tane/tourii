			...
			<div className="mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20">
				...
				<section id={useId()} className="mb-12">
					...
					<ul className="list-disc pl-6 space-y-2 text-warmGrey4">
						<li>
							<strong>Authentication:</strong> To log you in and keep you signed
							in
						</li>
						<li>
						...
						<li>
							<strong>Analytics:</strong> To understand how you use our platform
						</li>
						<li>
						...
						<table className="w-full text-sm">
							<thead>
								<tr className="border-b border-warmGrey2">
									<th className="text-left py-2 text-charcoal">Cookie Name</th>
				...
				<section id={useId()} className="mb-12">
					...
					<ul className="list-disc pl-6 space-y-2 text-warmGrey4 mb-4">
						...
						<li>
							<strong>Social Media Platforms:</strong> When you share content or
							log in
						</li>
						<li>
				...
				<section id={useId()} className="mb-12">
					...
					<ul className="list-disc pl-6 space-y-2 text-warmGrey4">
						...
						<li>
							<strong>Device Fingerprinting:</strong> To identify unique devices
							for security
						</li>
					</ul>
				</section>
