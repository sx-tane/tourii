...
import { routeDestinations1 } from "@/lib/data/model-route/bungo-ono/model-route-data-1";
import { routeDestinations2 } from "@/lib/data/model-route/bungo-ono/model-route-data-2";
import { routeDestinations3 } from "@/lib/data/model-route/bungo-ono/model-route-data-3";
import { routeDestinations4 } from "@/lib/data/model-route/bungo-ono/model-route-data-4";
