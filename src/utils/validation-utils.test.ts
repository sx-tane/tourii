...
describe('validation-utils', () => {
	...
	describe('validateTouristSpot', () => {
		...
		it('should detect potentially dangerous HTML in names and addresses', () => {
			...
			expect(result.isValid).toBe(false);
			expect(result.errors).toContain('Tourist spot name contains potentially unsafe HTML characters');
			expect(result.errors).toContain('Address contains potentially unsafe HTML characters');
		});
	});
