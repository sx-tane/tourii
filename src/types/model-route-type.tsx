...
export type BottomSectionProps = RouteDetailProps;

export type ModelRouteLocationProps = RouteDetailProps;

export type IntroUpperSectionProps = RouteDetailProps;
...
//       - 1. Image with image 1,2,undefined
