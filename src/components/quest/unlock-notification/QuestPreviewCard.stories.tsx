...
const mockPremiumQuestData: QuestUnlockData = {
  ...
  questDesc: "Gain exclusive access to restricted areas of the shrine and participate in special ceremonies.",
...
const mockQuestWithoutImage: QuestUnlockData = {
  ...
  questDesc: "Ring the ancient temple bell and learn about its historical significance.",
  questImage: null,
...
export const LongContent: Story = {
  args: {
    quest: {
      ...mockQuestData,
      questName: "An Extremely Long Quest Name That Tests Text Wrapping and Truncation",
      questDesc: "This is a very long quest description that should demonstrate how the component handles text overflow and ensures proper line clamping. It contains multiple sentences to test the layout behavior with extensive content that might exceed the normal display area."
    },
    className: "w-80"
  }
};
  ...
  decorators: [
    (Story) => (
      <div className="grid grid-cols-2 gap-4 p-4">
        ...
        <QuestPreviewCard quest={{...mockQuestData, questName: "Short Quest"}} className="w-72" />
      </div>
    )
  ]
};