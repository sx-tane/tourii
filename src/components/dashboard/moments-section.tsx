...
const mockMoments = [
	{
		...
		description:
			"Just visited this amazing shrine in Miyazaki! The architecture is breathtaking.",
	...
	},
	{
		...
		description:
			"The Inazumi Cave was incredible! Perfect for the underground quest.",
...
export function MomentsSection() {
	...
	const {
		...
		isError,
		error,
	} = useMoments("/api/moments?page=1&limit=5");
