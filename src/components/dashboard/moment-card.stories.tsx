...
const baseMoment = {
	...
	description:
		"Just visited this amazing shrine in Miyazaki! The architecture is breathtaking and the peaceful atmosphere made it perfect for meditation.",
...
export const WithBadgeReward: Story = {
	args: {
		moment: {
			...
			description:
				"Completed the temple visit quest. Such a peaceful experience!",
		},
	},
};
...
export const NoImage: Story = {
	args: {
		moment: {
			...
			imageUrl: null,
			description:
				"Shared a moment without a photo - sometimes words are enough!",
		},
	},
};
...
export const LongDescription: Story = {
	args: {
		moment: {
			...baseMoment,
			description:
				"This was absolutely incredible! The shrine has such rich history dating back centuries. I spent hours here learning about the local traditions and taking in the serene atmosphere. The gardens are particularly beautiful this time of year with cherry blossoms in full bloom.",
		},
	},
};
