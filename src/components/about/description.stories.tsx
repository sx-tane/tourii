...
export const Basic: Story = {
    args: {
        ...
        title: "Tourii",
        content: "A journey through Japanese mythology and folklore, where ancient tales come to life in a modern setting."
    }
};
...
export const WithImages: Story = {
    ...
    args: {
        smallTitle: "Meet Our",
        title: "Team",
        content: "The creative minds behind Tourii, bringing Japanese mythology to life.",
        images: [
...
export const WithSingleImage: Story = {
    ...
    args: {
        smallTitle: "Discover",
        title: "Our World",
        content: "Immerse yourself in a beautifully crafted world where tradition meets innovation.",
        images: [
            "/image/world/earth.png",
            "/image/world/heaven.png"
        ]
    }
};
...
export const Character: Story = {
    ...
    args: {
        ...
        content: "Ruler of the heavenly plains, bringer of light and life to the world."
    }
};
