...
const mockExperienceData = [
    {
        ...
        description: "Build and nurture a vibrant community around Tourii, fostering engagement and collaboration among members.",
        image: '/image/about/experience/kojiki-item.png'
    },
    {
        number: 2,
        title: "Governance",
        description: "Implement decentralized governance mechanisms that allow community members to participate in decision-making.",
        image: '/image/about/experience/kojiki-item.png'
    },
    {
        number: 3,
        title: "Rewards",
        description: "Create an engaging rewards system that incentivizes active participation and contribution to the ecosystem.",
        image: '/image/about/experience/kojiki-item.png'
    }
];
