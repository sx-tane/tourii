...
const defaultCrewMember: CrewInfoProps = {
    ...
    description: "Experienced developer with a passion for blockchain technology and Japanese culture.",
...
const mockCrewMembers: CrewInfoProps[] = [
    defaultCrewMember,
    {
        name: "Jane Smith",
        title: "UX Designer",
        description: "Creative designer focused on building intuitive blockchain experiences.",
        profileImage: "/image/about/crew/fc.jpg",
...
export const WithLongDescription: CardStory = {
    args: {
        crewMember: {
            ...defaultCrewMember,
            description: "Experienced developer with a passion for blockchain technology and Japanese culture. Leading the technical development of Tourii with a focus on creating immersive experiences that blend traditional storytelling with modern technology."
        }
    }
};
