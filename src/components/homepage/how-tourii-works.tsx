...
const defaultSections = [
	{
		...
		description:
			"Immerse yourself in mythological tales that unlock real-world destinations across Japan. Each story connects you to authentic cultural experiences.",
	...
	},
	{
		...
		description:
			"Engage in GPS-based adventures, QR code hunts, photo challenges, and group activities that reward you with digital collectibles and Tourii Points.",
	...
	},
	{
		...
		description:
			"Share your verified adventures, connect with fellow travelers, and build a blockchain-secured passport of your journey through Japan.",
