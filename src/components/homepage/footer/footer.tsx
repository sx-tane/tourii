	...
	return (
		<footer className="bg-charcoal border-t border-warmGrey5 py-12 px-6">
			<div className="max-w-6xl mx-auto">
					...
					<div className="md:col-span-2 space-y-4">
						<div className="flex items-center gap-3">
							<Image
								...
								className="w-10 h-10"
							/>
							<span className="text-white text-2xl font-bold">TOURII</span>
						</div>
						<p className="text-warmGrey3 text-sm leading-relaxed max-w-md">
				...
				{/* Bottom */}
				<div className="mt-12 pt-8 border-t border-warmGrey5 flex flex-col md:flex-row items-center justify-between gap-4">
					<p className="text-warmGrey3 text-xs">
						© 2024 Tourii. All rights reserved.
					</p>
					<div className="flex items-center gap-6">
						<Link
							href="https://twitter.com/tourii"
							className="text-warmGrey3 hover:text-white transition-colors"
							aria-label="Twitter"
						>
