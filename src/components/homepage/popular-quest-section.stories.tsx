...
export const Default: Story = {
	parameters: {
		docs: {
			description: {
				story:
					"Popular Quest Section with featured quests displayed in a grid layout.",
			},
		},
	},
};
...
export const WithApiData: Story = {
	parameters: {
		docs: {
			description: {
				story:
					"Popular Quest Section showing how it looks when API data is available.",
			},
		},
		mockData: {
			popularQuests: [
...
export const FallbackState: Story = {
	parameters: {
		docs: {
			description: {
				story:
					"Popular Quest Section showing fallback demo quests when API is unavailable.",
			},
		},
