					...
					>
						...
						<div className="items-center text-left lg:text-left lg:items-start pb-6 lg:pb-0 lg:pr-0 z-20">
							...
							>
								...
								unlocks location-based stories, and verifies your travel
								history. Complete quests, earn Tourii Points, and redeem them
								for exclusive perks—while connecting with others through shared,
								verified adventures.
							</motion.p>
						</div>
					</motion.div>
