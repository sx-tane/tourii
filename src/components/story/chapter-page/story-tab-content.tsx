...
interface StoryTabContentProps {
	...
	chapterToDisplay: StoryChapterResponseDto | undefined;
					...
					{sortedChapters.map((chapter) => (
						...
						>
							<button
								...
								onClick={
									chapter.isUnlocked
										? () => handleSelectChapter(chapter.storyChapterId)
										: undefined
								}
								disabled={!chapter.isUnlocked}
								className={`w-full text-left rounded transition-colors duration-150 flex items-center p-3 space-x-4 ${
									selectedChapterId === chapter.storyChapterId
										? "bg-warmGrey"
										: chapter.isUnlocked
