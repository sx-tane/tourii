...
interface ModelRouteSearchFiltersProps {
	searchQuery: string;
...
export default function ModelRouteSearchFilters({
	searchQuery,
	onSearchChange,
	activeFilters,
	onToggleFilter,
		...
		<div className="mb-6 space-y-4">
			...
			<div className="flex items-center gap-4">
				<div className="relative flex-1">
					...
					<input
						type="text"
						placeholder="Search routes by name, region, or story ID..."
						value={searchQuery}
