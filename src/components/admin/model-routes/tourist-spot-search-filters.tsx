...
interface TouristSpotSearchFiltersProps {
	searchQuery: string;
...
export default function TouristSpotSearchFilters({
	searchQuery,
	onSearchChange,
	activeFilters,
	onToggleFilter,
		...
		<div className="mb-6 space-y-4">
			...
			{activeFilters.length > 0 && (
				<div className="text-sm text-warmGrey3">
					Showing {filteredCount} of {totalSpots} tourist spots
				</div>
			)}
		</div>
	);
