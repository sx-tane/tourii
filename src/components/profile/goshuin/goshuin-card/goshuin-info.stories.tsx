...
const mockGoshuin: TravelGoshuin = {
	...
	goshuinDescription:
		"A historic temple in the heart of Tokyo, Senso-ji is the city's oldest Buddhist temple and one of its most significant. The temple was completed in 645 CE and is dedicated to Kannon, the goddess of mercy.",
